#
#  Be sure to run `pod spec lint PunchScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Christian Menschel"
  ...
  s.source       = { :git => "https://github.com/tapwork/PunchScrollView.git", :tag => "1.1.0" }
